...
{% hint style="warning" %}
A majority of current GC validators (running a GC node, not a beacon chain node) are now running the Nethermind client. The latest version 1.12.7 includes support for latest HF.\
\
